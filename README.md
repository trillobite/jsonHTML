...
Main Idea: You agree by downloading this work to hold me not responsible for whatever happens. You may view this code, and learn from it, and produce something similar, just if you make something and copy some of my code, you need to document it. I am allowing you to use my work free of charge, even if your a corporation, all I am asking is that you pay for it by giving me credit, so if someone else likes my code, they can see who actually wrote it.
